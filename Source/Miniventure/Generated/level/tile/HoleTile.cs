...
public class HoleTile : Tile
{
    ...
    public override void Render(Screen screen, Level level, int x, int y)
    {
        ...
        if (!u && !l)
        { // if the tile to the left, and the tile above can connect to params liquids[]
        ...
        if (!u && !r)
        { // if the tile to the right, and the tile above can connect to params liquids[]
        ...
        if (!d && !l)
        { // if the tile to the left, and the tile below can connect to params liquids[]
        ...
        if (!d && !r)
        { // if the tile to the right, and the tile below can connect to params liquids[]
