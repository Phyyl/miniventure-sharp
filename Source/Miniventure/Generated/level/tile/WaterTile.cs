...
public class WaterTile : Tile {
	public WaterTile(int id) : base(id) { // assigns the id
	...
	public override void render(Screen screen, Level level, int x, int y) {
		...
		if (!u && !l) { // if the tile to the left, and the tile above can connect to params water[]
		...
		if (!u && !r) { // if the tile to the right, and the tile above can connect to params water[]
		...
		if (!d && !l) { // if the tile to the left, and the tile below can connect to params water[]
		...
		if (!d && !r) { // if the tile to the right, and the tile below can connect to params water[]
