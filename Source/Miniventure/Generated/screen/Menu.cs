...
public class Menu {
	public Game game; // game object used in the menu classes.
	public InputHandler input; // input object used in the menu classes.
	...
	public void renderItemList<T>(Screen screen, int xo, int yo, int x1, int y1, List<T> listItems, int selected) where T : ListItem {
