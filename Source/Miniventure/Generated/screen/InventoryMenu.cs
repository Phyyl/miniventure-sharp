...
public class InventoryMenu : Menu {
	...
	public InventoryMenu(Player player) {
		...
		if (player.activeItem != null) { // If the player has an active item, params then[]
	...
	public override void tick() {
		...
		if (input.attack.clicked && len > 0) { // If your inventory is not empty, and the player presses the "Attack" params key[]
