...
{
    public static Resource wood = new("Wood", 1 + (4 * 32), Color.Get(-1, 200, 531, 430));
    public static Resource stone = new("Stone", 2 + (4 * 32), Color.Get(-1, 111, 333, 555));
    ...
    public static Resource wheat = new("Wheat", 6 + (4 * 32), Color.Get(-1, 110, 330, 550));
    ...
    public static Resource coal = new("COAL", 10 + (4 * 32), Color.Get(-1, 000, 111, 111));
    public static Resource ironOre = new("I.ORE", 10 + (4 * 32), Color.Get(-1, 100, 322, 544));
    public static Resource goldOre = new("G.ORE", 10 + (4 * 32), Color.Get(-1, 110, 440, 553));
    public static Resource ironIngot = new("IRON", 11 + (4 * 32), Color.Get(-1, 100, 322, 544));
    public static Resource goldIngot = new("GOLD", 11 + (4 * 32), Color.Get(-1, 110, 330, 553));

    public static Resource slime = new("SLIME", 10 + (4 * 32), Color.Get(-1, 10, 30, 50));
    public static Resource glass = new("glass", 12 + (4 * 32), Color.Get(-1, 555, 555, 555));
    public static Resource cloth = new("cloth", 1 + (4 * 32), Color.Get(-1, 25, 252, 141));
    public static Resource cloud = new PlantableResource("cloud", 2 + (4 * 32), Color.Get(-1, 222, 555, 444), Tile.Cloud, Tile.InfiniteFall);
    public static Resource gem = new("gem", 13 + (4 * 32), Color.Get(-1, 101, 404, 545));
    ...
    public readonly int sprite; // the sprite of the resource
    public readonly int color; // the color of the resource
    ...
    public Resource(string name, int sprite, int color)
    {
        ...
        if (name.Length > 6)
        {
            throw new Exception("Name cannot be longer than six characters!");
        }
