...
{
    private readonly List<Tile> sourceTiles; // list of tiles it can be plated on
    private readonly Tile targetTile; // what the source tile turns into when planted. (sapling/wheat seed)
