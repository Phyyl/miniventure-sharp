...
public class TreeTile : Tile {
	public TreeTile(int id) : base(id) { // assigns the tile's id
	...
	public override void render(Screen screen, Level level, int x, int y) {
		...
		if (u && ul && l) { // if there is a tree above, to the left, and to the upper left of this tile params then[]
		...
		if (u && ur && r) { // if there is a tree above, to the right, and to the upper right of this tile params then[]
		...
		if (d && dl && l) { // if there is a tree below, to the left, and to the bottom left of this tile params then[]
		...
		if (d && dr && r) { // if there is a tree below, to the right, and to the bottom right of this tile params then[]
	...
	public override bool interact(Level level, int xt, int yt, Player player, Item item, int attackDir) {
		if (item is ToolItem) { // if the item is a params tool[]
			ToolItem tool = (ToolItem) item; // converts the Item object to a ToolItem object
			if (tool.type == ToolType.axe) { // if the type of tool is an params axe[]
