...
public class Color {
	...
	*/
	...
	public static int get(int a, int b, int c, int d) {
		return (get(d) << 24) // gets the d value, and shifts its bit's 24 times to the left and params adds[]
		+ (get(c) << 16) // gets the c value, and shifts its bit's 16 times to the left and params adds[]
		+ (get(b) << 8) // gets the b value, and shifts its bit's 8 times to the left and params adds[]
