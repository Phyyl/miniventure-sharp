...
public class Slime : Mob {
	...
	public override void tick() {
		...
		if (!move(xa * speed, ya * speed) || random.nextInt(40) == 0) { //moves the params slime[] doubles as a check to see if it's still moving -OR- random chance out of 40
	...
	public virtual void touchedBy(Entity entity) {
		if (entity is Player) { // if we touch the player
